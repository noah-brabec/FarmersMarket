...
var $author$project$Login$viewBody = function (model) {
	return A2(
	...
	return {
		body: _List_fromArray(
			[
				...
				_List_fromArray(
					[
						$author$project$Login$viewBody(model)
					]))
			]),
		title: model.title
	};
};
var $author$project$Login$main = $elm$browser$Browser$document(
