...
var $PaackEng$elm_google_maps$GoogleMaps$Map$Map = function (a) {
	return {$: 'Map', a: a};
};
var $PaackEng$elm_google_maps$Internals$Map$Map = function (a) {
	return {$: 'Map', a: a};
};
var $PaackEng$elm_google_maps$Internals$Map$Roadmap = {$: 'Roadmap'};
var $PaackEng$elm_google_maps$Internals$Map$Events$init = {onMapClick: $elm$core$Maybe$Nothing, onMapReady: $elm$core$Maybe$Nothing};
var $PaackEng$elm_google_maps$Internals$Map$initControls = {defaultUI: true, mapType: true, streetView: true, zoom: true};
var $PaackEng$elm_google_maps$Internals$Map$init = function (apiKey) {
	return $PaackEng$elm_google_maps$Internals$Map$Map(
		{apiKey: apiKey, center: $elm$core$Maybe$Nothing, controls: $PaackEng$elm_google_maps$Internals$Map$initControls, events: $PaackEng$elm_google_maps$Internals$Map$Events$init, mapStyle: $elm$core$Maybe$Nothing, mapType: $PaackEng$elm_google_maps$Internals$Map$Roadmap, markers: _List_Nil, maxZoom: 20, minZoom: 0, polygons: _List_Nil, shouldFitToMarkers: false, zoom: 14});
};
var $PaackEng$elm_google_maps$GoogleMaps$Map$init = function (apiKey) {
	return $PaackEng$elm_google_maps$GoogleMaps$Map$Map(
		$PaackEng$elm_google_maps$Internals$Map$init(apiKey));
};
var $PaackEng$elm_google_maps$Internals$Helpers$addIf = F3(
	function (shouldAdd, item, list) {
		return shouldAdd ? A2($elm$core$List$cons, item, list) : list;
	});
...
var $PaackEng$elm_google_maps$Internals$Map$intToAttribute = F2(
...
var $PaackEng$elm_google_maps$Internals$Map$mapTypeToAttribute = function (mapType) {
	return A2(
		$elm$html$Html$Attributes$attribute,
		'map-type',
		function () {
...
var $PaackEng$elm_google_maps$Internals$Map$baseAttributes = function (options) {
	return _List_fromArray(
		[
			A2($elm$html$Html$Attributes$attribute, 'api-key', options.apiKey),
			A2($elm$html$Html$Attributes$attribute, 'click-events', 'true'),
			A2($PaackEng$elm_google_maps$Internals$Map$intToAttribute, 'zoom', options.zoom),
			A2($PaackEng$elm_google_maps$Internals$Map$intToAttribute, 'min-zoom', options.minZoom),
			A2($PaackEng$elm_google_maps$Internals$Map$intToAttribute, 'max-zoom', options.maxZoom),
			A2($elm$html$Html$Attributes$style, 'height', '100%'),
			$PaackEng$elm_google_maps$Internals$Map$mapTypeToAttribute(options.mapType)
		]);
};
...
var $PaackEng$elm_google_maps$Internals$Helpers$maybeAdd = F3(
	function (toAttrsFn, maybeItem, attrs) {
		return A2(
			...
			A2(
				...
				A2(
					...
					toAttrsFn,
					$elm$core$List$append(attrs)),
				maybeItem));
	});
var $PaackEng$elm_google_maps$Internals$Map$centerAttributes = F2(
	function (center, attrs) {
		return A3(
			$PaackEng$elm_google_maps$Internals$Helpers$maybeAdd,
			function (_v0) {
				var latitude = _v0.a;
				var longitude = _v0.b;
				return _List_fromArray(
...
var $PaackEng$elm_google_maps$Internals$Map$controlsAttributes = F2(
	function (controls, attrs) {
		return A3(
			$PaackEng$elm_google_maps$Internals$Helpers$addIf,
			!controls.streetView,
			A2($elm$html$Html$Attributes$attribute, 'disable-street-view-control', 'true'),
			A3(
				$PaackEng$elm_google_maps$Internals$Helpers$addIf,
				!controls.mapType,
				A2($elm$html$Html$Attributes$attribute, 'disable-map-type-control', 'true'),
				A3(
					$PaackEng$elm_google_maps$Internals$Helpers$addIf,
					!controls.zoom,
					A2($elm$html$Html$Attributes$attribute, 'disable-zoom', 'true'),
					A3(
						$PaackEng$elm_google_maps$Internals$Helpers$addIf,
						!controls.defaultUI,
						A2($elm$html$Html$Attributes$attribute, 'disable-default-ui', 'true'),
						attrs))));
	});
...
var $PaackEng$elm_google_maps$Internals$Marker$toHtml = function (_v0) {
	var marker = _v0.a;
	var attrs = A3(
		$PaackEng$elm_google_maps$Internals$Helpers$maybeAdd,
		function (msg) {
		...
		A3(
			...
			function (icon) {
				return _List_fromArray(
					[
						A2($elm$html$Html$Attributes$attribute, 'icon', icon)
					]);
			},
			marker.icon,
			A3(
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$Attributes$attribute,
						'latitude',
						$elm$core$String$fromFloat(marker.latitude)),
						A2(
						$elm$html$Html$Attributes$attribute,
						'longitude',
						$elm$core$String$fromFloat(marker.longitude)),
						A2($elm$html$Html$Attributes$attribute, 'slot', 'markers')
					]))));
	return A3($elm$html$Html$node, 'google-map-marker', attrs, _List_Nil);
};
var $PaackEng$elm_google_maps$Internals$Polygon$buildPointHtml = function (_v0) {
	var latitude = _v0.a;
	var longitude = _v0.b;
	return A3(
		$elm$html$Html$node,
...
var $PaackEng$elm_google_maps$Internals$Polygon$toHtml = function (_v0) {
	var polygon = _v0.a;
	var points = A2($elm$core$List$map, $PaackEng$elm_google_maps$Internals$Polygon$buildPointHtml, polygon.points);
	var attrs = A3(
		$PaackEng$elm_google_maps$Internals$Helpers$maybeAdd,
		function (msg) {
			return _List_fromArray(
				[
					A2(
					$elm$html$Html$Events$on,
					'google-map-poly-click',
					$elm$json$Json$Decode$succeed(msg)),
					A2($elm$html$Html$Attributes$attribute, 'click-events', 'true'),
					A2($elm$html$Html$Attributes$attribute, 'clickable', 'true')
				]);
		},
		polygon.onClick,
		A3(
			...
			_List_fromArray(
				[
					A2($elm$html$Html$Attributes$attribute, 'fill-color', polygon.fillColor),
					A2(
					$elm$html$Html$Attributes$attribute,
					'fill-opacity',
					$elm$core$String$fromFloat(polygon.fillOpacity)),
					A2(
					$elm$html$Html$Attributes$attribute,
					'stroke-weight',
					$elm$core$String$fromInt(polygon.strokeWeight)),
					A2($elm$html$Html$Attributes$attribute, 'stroke-color', polygon.strokeColor),
					A2(
					$elm$html$Html$Attributes$attribute,
					'z-index',
					$elm$core$String$fromInt(polygon.zIndex))
				])));
	return A3($elm$html$Html$node, 'google-map-poly', attrs, points);
};
var $PaackEng$elm_google_maps$Internals$Map$Events$toHtmlAttributes = function (events) {
	return A3(
		$PaackEng$elm_google_maps$Internals$Helpers$maybeAdd,
		function (msg) {
			return _List_fromArray(
...
var $PaackEng$elm_google_maps$Internals$Map$toHtml = function (_v0) {
	var map = _v0.a;
	var polygons = A2($elm$core$List$map, $PaackEng$elm_google_maps$Internals$Polygon$toHtml, map.polygons);
	var markers = A2($elm$core$List$map, $PaackEng$elm_google_maps$Internals$Marker$toHtml, map.markers);
	var attributes = A3(
		$PaackEng$elm_google_maps$Internals$Helpers$addIf,
		map.shouldFitToMarkers,
		...
		A3(
			...
			function (mapStyle) {
				return _List_fromArray(
					[
						A2($elm$html$Html$Attributes$attribute, 'styles', mapStyle)
					]);
			},
			map.mapStyle,
			A2(
				$PaackEng$elm_google_maps$Internals$Map$centerAttributes,
				map.center,
				A2(
					$PaackEng$elm_google_maps$Internals$Map$controlsAttributes,
					map.controls,
					A2(
						$elm$core$List$append,
						$PaackEng$elm_google_maps$Internals$Map$Events$toHtmlAttributes(map.events),
						$PaackEng$elm_google_maps$Internals$Map$baseAttributes(map))))));
	return A3(
		$elm$html$Html$node,
		'google-map',
		attributes,
		A2($elm$core$List$append, markers, polygons));
};
var $PaackEng$elm_google_maps$GoogleMaps$Map$toHtml = function (_v0) {
	var map = _v0.a;
	return $PaackEng$elm_google_maps$Internals$Map$toHtml(map);
};
var $author$project$BootTest$mapView = function (apiKey) {
	return $PaackEng$elm_google_maps$GoogleMaps$Map$toHtml(
		$PaackEng$elm_google_maps$GoogleMaps$Map$init(apiKey));
};
...
var $author$project$BootTest$main = A2(
		...
		[
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$author$project$BootTest$mapView('AIzaSyAkNCeNZNQ4PHWhp4bLzeoVyZULwbXMizc')
						]))
				]))
		]));
_Platform_export({'BootTest':{'init':_VirtualDom_init($author$project$BootTest$main)(0)(0)}});}(this));